...
const CardContent: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, ...props }) => (
  ...
  export const CheckRarity = ()=> {
    return (
      <main className="relative w-full min-h-[806px] bg-[#121211] overflow-hidden">
        <div className="w-full flex justify-center">
          <div className="relative w-full max-w-[1440px] h-[806px]">
            ...
            <div className="absolute w-full h-[802px] top-0 left-0 opacity-10">
              <div className="relative h-[802px]">
                ...
                />
                <img
                  className="absolute w-[880px] h-[646px] top-[156px] left-[280px]"
            ...
            {/* Content section */}
            <section className="flex flex-col items-start gap-9 absolute top-[142px] right-[62px] max-w-[535px]">
              {/* Header section */}
